				...
				<div className='about-content'>
					<div className='about-text'>
						<div className='about-card'>
							<h3>Who I Am</h3>
							<p>
								I'm a passionate Full Stack Developer with over 7 years of experience creating
							...
							<p>
								...
								building products that make a difference. I believe in writing clean, maintainable
						...
						<div className='about-card'>
							<h3>What I Do</h3>
							<p>
								I develop full-stack web applications using modern technologies like React, Node.js,
								and TypeScript. From concept to deployment, I handle every aspect of the development
								process.
							</p>
							<p>
								My expertise includes frontend development, backend API design, database management,
								and cloud deployment. I'm always learning and staying up-to-date with the latest
